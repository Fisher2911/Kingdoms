...
public class DoubleUpgrades extends NumberUpgrades<Double> {
    ...
    public DoubleUpgrades(String id, String displayName, Expression expression, Expression moneyPriceExpression, int maxLevel, ItemBuilder displayItem, ItemBuilder maxLevelDisplayItem) {
