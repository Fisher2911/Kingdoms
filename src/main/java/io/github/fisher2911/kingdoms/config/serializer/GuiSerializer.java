...
public class GuiSerializer {
    ...
    private static final String FILLER_ITEM_PATH = "filler";
    private static final String ITEMS_PATH = "items";
    private static final boolean CANCEL_CLICKS_PATH = true;

    private static final String GUI_FILLERS_PATH = "gui-fillers";

    public static BaseGui deserialize(ConfigurationNode source) throws SerializationException {
        final String id = source.node(ID_PATH).getString();
        final String title = source.node(TITLE_PATH).getString();
        ...
        final var fillerNode = source.node(FILLER_ITEM_PATH);
        ...
        final BaseGuiItem filler = GuiItemSerializer.INSTANCE.deserialize(BaseGuiItem.class, fillerNode);
