...
public class ItemSerializer implements TypeSerializer<ItemBuilder> {
    ...
    @Override
    public void serialize(Type type, @Nullable ItemBuilder obj, ConfigurationNode node) throws SerializationException {
