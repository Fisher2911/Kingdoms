...
//            ConditionType.PARSE_PLACEHOLDERS, KingdomsConditionSerializer::loadPlaceholderConditions,
//            ConditionType.HAS_K_PERMISSIONS, KingdomsConditionSerializer::loadKPermissionPlaceholderConditions
//    );


    private KingdomsConditionSerializer() {
        this.registerLoader(ConditionType.HAS_K_PERMISSIONS.toString().toLowerCase(), this::loadKPermissionPlaceholderConditions);
    }

//    public static ItemConditions loadConditional(ConfigurationNode source) throws SerializationException {
//        final ConditionalItem item = KingdomsGuiItemSerializer.INSTANCE.deserialize(ConditionalItem.class, source);
...
//            }
//            final var loader = this.lo.get(type);
//            if (loader == null) {
...
//    }
    ...
    private static final Map<GuiKey, Function<Metadata, List<Object>>> PLACEHOLDER_CONDITIONS_PLACEHOLDER_FUNCTIONS = Map.of(
            GuiKeys.K_PERMISSION, metadata -> {
...
//    }
    ...
    private List<MetadataPredicate> loadKPermissionPlaceholderConditions(Kingdoms plugin, ConfigurationNode base, ConfigurationNode source) {
        try {
